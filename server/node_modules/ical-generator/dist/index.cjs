"use strict";var Z=Object.create;var R=Object.defineProperty;var Q=Object.getOwnPropertyDescriptor;var K=Object.getOwnPropertyNames,j=Object.getOwnPropertySymbols,$=Object.getPrototypeOf,H=Object.prototype.hasOwnProperty,_=Object.prototype.propertyIsEnumerable;var G=(a,t,e)=>t in a?R(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e,T=(a,t)=>{for(var e in t||(t={}))H.call(t,e)&&G(a,e,t[e]);if(j)for(var e of j(t))_.call(t,e)&&G(a,e,t[e]);return a};var tt=(a,t)=>{for(var e in t)R(a,e,{get:t[e],enumerable:!0})},W=(a,t,e,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of K(t))!H.call(a,i)&&i!==e&&R(a,i,{get:()=>t[i],enumerable:!(n=Q(t,i))||n.enumerable});return a};var et=(a,t,e)=>(e=a!=null?Z($(a)):{},W(t||!a||!a.__esModule?R(e,"default",{value:a,enumerable:!0}):e,a)),at=a=>W(R({},"__esModule",{value:!0}),a);var lt={};tt(lt,{ICalAlarm:()=>p,ICalAlarmRelatesTo:()=>Y,ICalAlarmType:()=>z,ICalAttendee:()=>f,ICalAttendeeRole:()=>w,ICalAttendeeStatus:()=>V,ICalAttendeeType:()=>L,ICalCalendar:()=>A,ICalCalendarMethod:()=>F,ICalCategory:()=>D,ICalEvent:()=>y,ICalEventBusyStatus:()=>B,ICalEventClass:()=>k,ICalEventRepeatingFreq:()=>x,ICalEventStatus:()=>U,ICalEventTransparency:()=>P,ICalWeekday:()=>S,default:()=>st,escape:()=>s,foldLines:()=>v,formatDate:()=>d,formatDateTZ:()=>E});module.exports=at(lt);function d(a,t,e,n){if(a!=null&&a.startsWith("/")&&(a=a.substr(1)),typeof t=="string"||t instanceof Date){let i=new Date(t),r=i.getUTCFullYear()+String(i.getUTCMonth()+1).padStart(2,"0")+i.getUTCDate().toString().padStart(2,"0");return a&&(r=i.getFullYear()+String(i.getMonth()+1).padStart(2,"0")+i.getDate().toString().padStart(2,"0")),e?r:a?(r+="T"+i.getHours().toString().padStart(2,"0")+i.getMinutes().toString().padStart(2,"0")+i.getSeconds().toString().padStart(2,"0"),r):(r+="T"+i.getUTCHours().toString().padStart(2,"0")+i.getUTCMinutes().toString().padStart(2,"0")+i.getUTCSeconds().toString().padStart(2,"0")+(n?"":"Z"),r)}else if(N(t)){let i=a?nt(t)&&!t.tz()?t.clone().tz(a):t:n?t:t.utc();return i.format("YYYYMMDD")+(e?"":"T"+i.format("HHmmss")+(n||a?"":"Z"))}else if(O(t)){let i=a?t.setZone(a):n?t:t.setZone("utc");return i.toFormat("yyyyLLdd")+(e?"":"T"+i.toFormat("HHmmss")+(n||a?"":"Z"))}else{let i=t;if(a)i=typeof t.tz=="function"?t.tz(a):t;else if(!n)if(typeof t.utc=="function")i=t.utc();else throw new Error("Unable to convert dayjs object to UTC value: UTC plugin is not available!");return i.format("YYYYMMDD")+(e?"":"T"+i.format("HHmmss")+(n||a?"":"Z"))}}function E(a,t,e,n){let i="",r=(n==null?void 0:n.floating)||!1;return n!=null&&n.timezone&&(i=";TZID="+n.timezone,r=!0),t+i+":"+d(a,e,!1,r)}function s(a,t){return String(a).replace(t?/[\\"]/g:/[\\;,]/g,function(e){return"\\"+e}).replace(/(?:\r\n|\r|\n)/g,"\\n")}function v(a){return a.split(`\r
...
`),t+=`END:VEVENT\r
`,t}};var F=(C=>(C.PUBLISH="PUBLISH",C.REQUEST="REQUEST",C.REPLY="REPLY",C.ADD="ADD",C.CANCEL="CANCEL",C.REFRESH="REFRESH",C.COUNTER="COUNTER",C.DECLINECOUNTER="DECLINECOUNTER",C))(F||{}),A=class{constructor(t={}){this.data={prodId:"//sebbo.net//ical-generator//EN",method:null,name:null,description:null,timezone:null,source:null,url:null,scale:null,ttl:null,events:[],x:[]},t.prodId!==void 0&&this.prodId(t.prodId),t.method!==void 0&&this.method(t.method),t.name!==void 0&&this.name(t.name),t.description!==void 0&&this.description(t.description),t.timezone!==void 0&&this.timezone(t.timezone),t.source!==void 0&&this.source(t.source),t.url!==void 0&&this.url(t.url),t.scale!==void 0&&this.scale(t.scale),t.ttl!==void 0&&this.ttl(t.ttl),t.events!==void 0&&this.events(t.events),t.x!==void 0&&this.x(t.x)}prodId(t){if(!t)return this.data.prodId;if(typeof t=="string")return this.data.prodId=t,this;if(typeof t!="object")throw new Error("`prodid` needs to be a string or an object!");if(!t.company)throw new Error("`prodid.company` is a mandatory item!");if(!t.product)throw new Error("`prodid.product` is a mandatory item!");let e=(t.language||"EN").toUpperCase();return this.data.prodId="//"+t.company+"//"+t.product+"//"+e,this}method(t){return t===void 0?this.data.method:t?(this.data.method=h(F,t),this):(this.data.method=null,this)}name(t){return t===void 0?this.data.name:(this.data.name=t?String(t):null,this)}description(t){return t===void 0?this.data.description:(this.data.description=t?String(t):null,this)}timezone(t){var e;return t===void 0?((e=this.data.timezone)==null?void 0:e.name)||null:(t==="UTC"?this.data.timezone=null:typeof t=="string"?this.data.timezone={name:t}:t===null?this.data.timezone=null:this.data.timezone=t,this)}source(t){return t===void 0?this.data.source:(this.data.source=t||null,this)}url(t){return t===void 0?this.data.url:(this.data.url=t||null,this)}scale(t){return t===void 0?this.data.scale:(t===null?this.data.scale=null:this.data.scale=t.toUpperCase(),this)}ttl(t){return t===void 0?this.data.ttl:(q(t)?this.data.ttl=t.asSeconds():t&&t>0?this.data.ttl=t:this.data.ttl=null,this)}createEvent(t){let e=t instanceof y?t:new y(t,this);return this.data.events.push(e),e}events(t){return t?(t.forEach(e=>this.createEvent(e)),this):this.data.events}clear(){return this.data.events=[],this}x(t,e){if(t===void 0)return o(this.data);if(typeof t=="string"&&typeof e=="string")o(this.data,t,e);else if(typeof t=="object")o(this.data,t);else throw new Error("Either key or value is not a string!");return this}toJSON(){return Object.assign({},this.data,{timezone:this.timezone(),events:this.data.events.map(t=>t.toJSON()),x:this.x()})}length(){return this.data.events.length}toString(){var e,n;let t="";return t=`BEGIN:VCALENDAR\r
VERSION:2.0\r
