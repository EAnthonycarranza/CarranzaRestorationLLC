        ...
        <div className="row g-5 portfolio-container">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 portfolio-item first">
                <div className="position-relative portfolio-box">
                    ...
                    <a className="portfolio-btn" href={portfolio1} data-lightbox="portfolio">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 portfolio-item second">
                <div className="position-relative portfolio-box">
                    ...
                    <a className="portfolio-btn" href={portfolio2} data-lightbox="portfolio">
                        <i className="bi bi-plus text-white"></i>
                    </a>
                </div>
            </div>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 portfolio-item first">
                <div className="position-relative portfolio-box">
                    ...
                    <a className="portfolio-btn" href={portfolio3} data-lightbox="portfolio">
                        <i className="bi bi-plus text-white"></i>
                    </a>
                </div>
            </div>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 portfolio-item second">
                <div className="position-relative portfolio-box">
                    ...
                    <a className="portfolio-btn" href={portfolio4} data-lightbox="portfolio">
                        <i className="bi bi-plus text-white"></i>
                    </a>
                </div>
            </div>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 portfolio-item first">
                <div className="position-relative portfolio-box">
                    ...
                    <a className="portfolio-btn" href={portfolio5} data-lightbox="portfolio">
                        <i className="bi bi-plus text-white"></i>
                    </a>
                </div>
            </div>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 portfolio-item second">
                <div className="position-relative portfolio-box">
                    ...
                    <a className="portfolio-btn" href={portfolio6} data-lightbox="portfolio">
                        <i className="bi bi-plus text-white"></i>
                    </a>
                </div>
            </div>
